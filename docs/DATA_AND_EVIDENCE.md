...
- **Costco:** [Grocery Store Dataset](https://www.kaggle.com/datasets/bhavikjikadara/grocery-store-dataset), described by the source project as a Costco marketplace snapshot under CC BY 4.0.
- **Walmart:** [Walmart Grocery Product Dataset](https://www.kaggle.com/datasets/polartech/walmart-grocery-product-dataset), identified as CC0 on Kaggle.
